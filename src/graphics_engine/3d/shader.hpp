...
class Shader{
    ...
    //~Shader();
    virtual void loadVertexData(Mesh mesh)=0;
    ...
    virtual void loadTextureData(TextureData tex)=0;
    //load multiple texture files
    virtual void loadTextureList(vector<TextureData> texture_list)=0;
    // draw the textures
