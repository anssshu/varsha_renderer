...
void Camera2D::setUniforms(unsigned int shaderProgram)
{
    target.x = pos.x;
    target.y = pos.y;
    view = lookAt(pos,target,up);
...
//________________________________________CAMERA IMPLEMENTATION_______________________________________________________________________
